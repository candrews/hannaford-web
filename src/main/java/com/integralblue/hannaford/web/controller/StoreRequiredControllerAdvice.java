...
@ControllerAdvice
public class StoreRequiredControllerAdvice {

	@ExceptionHandler(StoreRequiredException.class)
	public View storeRequired(HttpServletRequest request) throws UnsupportedEncodingException{
