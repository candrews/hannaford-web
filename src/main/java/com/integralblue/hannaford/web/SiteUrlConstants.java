...
public interface SiteUrlConstants {
	public static final String STORE_LOCATOR="/custserv/locate_store.cmd";
	public static final String WEEKLY_FLYER="/catalog/weekly_flyer.cmd";
